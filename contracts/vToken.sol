...
contract vToken is IvToken, Initializable, AccessControl, ReentrancyGuardUpgradeable, ERC165Upgradeable {
    ...
    // onlyRole is commented out to switch to native AccessControl checking on vToken itself, not registry.
    ...
    constructor() {
        // The deployer automatically gets the DEFAULT_ADMIN_ROLE
    ...
    function supportsInterface(bytes4 _interfaceId) public view virtual override(ERC165Upgradeable, AccessControl) returns (bool) {
